...
# cube_length = 4
# cube_volume = length_cubed(4)
# puts "If cube length is 4 its volume is #{cube_volume}"

# puts "Enter a number"
# cube_length = gets.chomp.to_i
# cube_volume = length_cubed(cube_length)
# puts "If cube length is #{cube_length} its volume is #{cube_volume}"
